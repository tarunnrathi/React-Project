...
class TemporaryGridWeekOff extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns1: [
  ...
  saveHandler = (e) => {
   ...
   // if (this.props.Data.length > 0) {
     ...
     var url=`${axios.baseURL}/Employee_Shift_WeekOff/PostEmployeeShiftWeekOff?ActionType=Add`;
     //var url=`http://localhost:52227/api/Employee_Shift_WeekOff/PostEmployeeShiftWeekOff?ActionType=Add`;
    ...
    var finalData = {
      ...
      CompanyId: this.props.compId,
      WeekOffday: this.state.weekOff===""?this.props.Data[0].WeekOffday:this.state.weekOff,        
      CreatedBy: this.props.user.info.EmpId,
      Applicable_Date: this.state.startDate,
    }
      var arr = new Array();
      arr.push(finalData);
     // var url = `${axios.baseURL}/EmployeeShift/PostEmployeeShift?ActionType=Add`;
     var url=`${axios.baseURL}/Employee_Shift_WeekOff/PostEmployeeShiftWeekOff?ActionType=Edit`;
     //var url=`http://localhost:52227/api/Employee_Shift_WeekOff/PostEmployeeShiftWeekOff?ActionType=Edit`;
      // var url=`http://localhost:52227/api/EmployeeShift/PostEmployeeShift?ActionType=Edit`;
     // this.save(url, arr);
              ...
              <div className="col-md-4">
                <div className="row mb-2">
                  ...
                  <div className="col-md-8">
                    <select className="form-control"
                      name="weekOff"
                      value={this.props.Mode==="Edit" && this.props.Data.length>0 && this.state.weekOff===""?this.props.Data[0].WeekOffday:this.state.weekOff}
                      onChange={this.changeWeekOffHandler}
                    >
                      <option placeholder="" value={""}>Select</option>
                      <option placeholder="" value={"MONDAY"}>MONDAY</option>
                      <option placeholder="" value={"TUESDAY"}>TUESDAY</option>
                      <option placeholder="" value={"WEDNESDAY"}>WEDNESDAY</option>
                      <option placeholder="" value={"THURSDAY"}>THURSDAY</option>
                      <option placeholder="" value={"FRIDAY"}>FRIDAY</option>
                      <option placeholder="" value={"SATERDAY"}>SATERDAY</option>
                      <option placeholder="" value={"SUNDAY"}>SUNDAY</option>
                    </select>
                  </div>
                </div>
              </div>
