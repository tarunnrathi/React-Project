...
import EmployeeShiftUI from './EmployeeShiftUIWeekOff';
...
var intervalId = "";
class EmployeeShiftWeekOff extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
   ...
   var url = `${axios.baseURL}/Employee_Shift_WeekOff/GetEmployee_Shift_WeekOff`;
   axios.get(url)
      .then((response, err) => {
  ...
  edit = () => {
    ...
    var url = `${axios.baseURL}/Employee_Shift_WeekOff/GetEmployeeShiftWeekOffById?EmpIdOrEmpName=${obj.empId[0]}&CompanyId=${obj.companyId[0]}&Id=${this.state.selected}`;
    axios.get(url)
    .then((res) => {
      debugger
  ...
  exportToExcle = () => {
    ...
    let fileName = "EmployeeShiftWeekOff/" + new Date().getTime();
  ...
  printTable = () => {
    ...
    table +=
      "<table><tr><th>Id</th><th>Employee Name</th><th>Department Name</th><th>Week Off day</th><th>Shift Name</th><th>Company Name</th><th>Applicable Date</th><th>CreatedBy</th><th>Created date</th></tr><th>Modify By</th><th>Modify Date</th>";
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header">
                    {this.state.Mode === "Add" ?
                      <h4>Add Employee Shift WeekOff</h4> : <h4>Edit Employee Shift</h4>}
        ...
        <main role="main">
          <ol className="ddhead mb-1">
            <li className="breadcrumb-item active text-dark">
              <h3>Employee Shift WeekOffday</h3>
            </li>
          </ol>
          <div className="row">
...
}), { setMenu, userInfo })(EmployeeShiftWeekOff);
