...
var intervalId = "";
class Materialgriddemo2 extends Component {
  _isMounted = false;
  constructor(props) {
    debugger;
    super(props);
    this.state = {
      ...
      Materialcolumn: [
        ...
        { title: 'EmployeeTypeId', field: 'EmployeeTypeId' },
  ...
  render() {
    const exportPdf = (allColumns, allData) => { //for Pdf Print
      debugger;
      var groupColName = ['DepartmentId', 'DesignationId', 'CompanyId', 'EmployeeTypeId'];
      var ReportTitle = 'Employee Master Report'
...
}), { setMenu, userInfo })(Materialgriddemo2);
